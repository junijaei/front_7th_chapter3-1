  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-neutral-900">
      <div className="mx-auto max-w-7xl p-5">
        <div className="mb-5">
          <h1 className="mb-1 text-2xl font-bold text-gray-800 dark:text-neutral-100">관리 시스템</h1>
          <p className="text-sm text-gray-600 dark:text-neutral-400">사용자와 게시글을 관리하세요</p>
        </div>
