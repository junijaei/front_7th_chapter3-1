...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div data-slot="table-container" className="relative w-full overflow-x-auto bg-white dark:bg-neutral-800">
      <table
        data-slot="table"
        className={cn('w-full caption-bottom text-sm text-gray-900 dark:text-neutral-100', className)}
        {...props}
      />
    </div>
  );
